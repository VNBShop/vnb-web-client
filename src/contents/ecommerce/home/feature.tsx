...
export default function Feature() {
  return (
    <section className="mt-28">
      ...
      <section className="max-w-[1100px] mx-auto px-4 grid md:grid-cols-3 md:grid-rows-[250px_50px_250px] gap-5 grid-cols-1 grid-rows-[250px_250px_250px_250px_250px]">
        ...
        <article className="col-span-1 row-span-1 rounded-lg p-4 flex flex-col justify-between shadow-f lg:row-span-2">
          ...
          <article>
            ...
            <p className="text-gray-500 text-start  text-color">
              ...
              company. Yonex produces equipment and apparel for tennis,
              badminton, golf.
        ...
        <article className="col-span-1 row-span-1 md:row-span-2 rounded-lg p-4 flex flex-col justify-between shadow-t">
          ...
          <article>
            ...
            <p className="text-gray-500 text-start  text-color">
              ...
              equipment company founded by former Olympic gymnast Li Ning.{' '}
              <span className="hidden lg:block">
